...
class DeviceData : Serializable {
    ...
    var battery: DeviceBattery? = null//电池信息
    ...
    var sensorList: ArrayList<SensorListInfo>? = null//传感器的详细信息
    var phone_type: String = ""//指示设备电话类型的常量。NONE：0，GS：1，CDMA：2，SIP=3
    var language: String? = null//系统语言 ，注意，不是locale_display_language
